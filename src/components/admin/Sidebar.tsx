    ...
    <aside className="fixed left-0 top-0 h-screen w-64 bg-gray-900 text-white flex flex-col z-50">
      ...
      <div className="px-6 py-5 border-b border-gray-700">
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="font-semibold text-sm leading-tight">Spijkersbouw</p>
            <p className="text-xs text-gray-400 leading-tight">Beheer</p>
          </div>
        </div>
      </div>
      ...
      {/* Profiel + website links */}
      <div className="px-3 pb-1 border-t border-gray-700 pt-3 space-y-1">
      ...
      <div className="px-3 pb-4 border-t border-gray-700 pt-3">
        <button
          onClick={() => signOut({ callbackUrl: "/admin/inloggen" })}
